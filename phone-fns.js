...
var validateCountryCode = function (phone, country) {
	var ref = breakdown(phone, true);
	var countryCode = ref.countryCode;

	return callingCodes[country.toLowerCase()].indexOf(countryCode) !== -1;
};

var isValid = function (phone, country) {
	var isValid = false;
...
var index$3 = function (code) {
	var foundCountries = [];

	for (var prop in callingCodes) {
...
var index$4 = function (country) { return callingCodes[country.toLowerCase()]; };
...
exports.findLocal = index$3;
exports.getCode = index$4;
